    ...
    <div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full bg-white text-black py-3 text-sm font-medium hover:bg-[#e5e5e5] transition-colors disabled:opacity-50"
        >
      ...
      <p className="mt-6 text-xs text-[#555] text-center">
        Já tem conta?{' '}
        <Link href="/login" className="text-[#e5e5e5] hover:underline">
          Entrar
        </Link>
      </p>
    </div>
